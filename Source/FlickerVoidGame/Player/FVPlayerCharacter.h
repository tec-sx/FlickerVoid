...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "FlickerVoid|Interaction")
	UFVInteractorResponseComponent* GetInteractionResponse() const { return InteractionResponse; }
...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "FlickerVoid|Interaction")
	TObjectPtr<UFVInteractorResponseComponent> InteractionResponse;

	UPROPERTY(VisibleAnywhere, Category = "FlickerVoid|Interaction")
	TObjectPtr<UFVInteractorResponseComponent_ActivateAbility> InteractionAbilityResponder;
};
