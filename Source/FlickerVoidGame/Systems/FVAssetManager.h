...
#include "FVAssetManagerStartupJob.h"
#include "Templates/SubclassOf.h"

#include "FVAssetManager.generated.h"
...
class UFVAssetManager : public UAssetManager
{
	GENERATED_BODY()
	
public:
	UE_API UFVAssetManager();

	static UE_API UFVAssetManager& Get();
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UFVPawnData> DefaultPawnData;
...
private:
	...
	TArray<FFVAssetManagerStartupJob> StartupJobs;

private:

	// Global game data asset to use.
	UPROPERTY(Config)
	TSoftObjectPtr<UFVGameData> FVGameDataPath;
...
template<typename AssetType>
inline AssetType* UFVAssetManager::GetAsset(const TSoftObjectPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
...
template<typename AssetType>
inline TSubclassOf<AssetType> UFVAssetManager::GetSubclass(const TSoftClassPtr<AssetType>& AssetPointer, bool bKeepInMemory)
{
