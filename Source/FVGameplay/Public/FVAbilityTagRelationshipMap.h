...
#include "FVAbilityTagRelationshipMap.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FFVAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class FLICKERVOIDGAMEPLAY_API UFVAbilityTagRelationshipMap : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<struct FFVAbilityTagRelationship> AbilityTagRelationships;
