...
class SFVFactSearchToggle : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SFVFactSearchToggle)
	...
	virtual ~SFVFactSearchToggle() override;
...
using SFactSearchToggleRef = TSharedRef<SFVFactSearchToggle>;
using SFactSearchTogglePtr = TSharedPtr<SFVFactSearchToggle>;
