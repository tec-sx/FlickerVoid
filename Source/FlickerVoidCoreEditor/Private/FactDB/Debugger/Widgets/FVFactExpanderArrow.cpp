...
#include "FVFactExpanderArrow.h"
#include "Framework/Application/SlateApplication.h"
#include "Widgets/Images/SImage.h"
#include "Widgets/Input/SButton.h"
#include "Widgets/Views/STableRow.h"

void SFVFactExpanderArrow::Construct( const FArguments& InArgs, const TSharedPtr<class ITableRow>& TableRow  )
{
	...
	this->ChildSlot
	.Padding( TAttribute< FMargin >( this, &SFVFactExpanderArrow::GetExpanderPadding ) )
	[
		SAssignNew( ExpanderArrow, SButton )
		.ButtonStyle( FCoreStyle::Get(), "NoBorder" )
		.VAlign( VAlign_Center )
		.HAlign( HAlign_Center )
		.Visibility( this, &SFVFactExpanderArrow::GetExpanderVisibility )
		.ClickMethod( EButtonClickMethod::MouseDown )
		.OnClicked( this, &SFVFactExpanderArrow::OnArrowClicked )
		.ContentPadding( 0.f )
		.ForegroundColor( FSlateColor::UseForeground() )
		.IsFocusable( false )
		[
			SNew( SImage )
			.Image( this, &SFVFactExpanderArrow::GetExpanderImage )
...
int32 SFVFactExpanderArrow::OnPaint( const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled ) const
{
...
FReply SFVFactExpanderArrow::OnArrowClicked()
{
...
EVisibility SFVFactExpanderArrow::GetExpanderVisibility() const
{
...
FMargin SFVFactExpanderArrow::GetExpanderPadding() const
{
...
const FSlateBrush* SFVFactExpanderArrow::GetExpanderImage() const
{
